...
set(CMAKE_SYSROOT /home/mccakit/dev/sysroots/arch-x64)
set(CMAKE_FIND_ROOT_PATH ${CMAKE_SYSROOT})
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
add_compile_options(--gcc-install-dir=${CMAKE_SYSROOT}/lib/gcc/${triple}/15.1.1)
add_link_options(--gcc-install-dir=${CMAKE_SYSROOT}/lib/gcc/${triple}/15.1.1)

set(CMAKE_CXX_FLAGS
    "${CMAKE_CXX_FLAGS} -nostdinc++ -nostdlib++ -isystem /home/mccakit/dev/libcxx/arch-x64/include/c++/v1"
)
set(CMAKE_EXE_LINKER_FLAGS
    "${CMAKE_EXE_LINKER_FLAGS} -L/home/mccakit/dev/libcxx/arch-x64/lib"
)
set(CMAKE_SHARED_LINKER_FLAGS
    "${CMAKE_SHARED_LINKER_FLAGS} -L/home/mccakit/dev/libcxx/arch-x64/lib"
)
